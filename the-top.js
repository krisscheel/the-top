...
const resize = function () {
  ...
  scoreScale.range([(420 / 960) * svgWidth, (900 / 960) * svgWidth]);

  groups.selectAll("circle.metascore").attr("cx", (d, i) => {
    return scoreScale(d.metascore);
  });

  groups.selectAll("circle.imdb").attr("cx", (d, i) => {
    return scoreScale(d.imdb);
  });
...
// and, run if I change the page width
resize();
